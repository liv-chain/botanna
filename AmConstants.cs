...
public static class AmConstants
{
    ...
    [
        ...
        "hai un talento raro: riesci a parlare tanto dicendo niente.",
        "stai trasformando l’aria in rumore, complimenti.",
        "hai finito di scaccolarti con la lingua o vai avanti?",
        "non so se stai parlando o cercando di evocare un demone.",
        "se c’era un punto, l’hai seppellito sotto dieci strati di fuffa.",
        "stai tenendo un TED Talk senza pubblico né invito.",
        "le tue parole sono come l’umidità: fastidiose e ovunque.",
        "sento il tuo ego respirare più forte di te.",
        "c'è un limite a tutto… tranne che alla tua voce, a quanto pare.",
        "sei il trailer ufficiale del nulla parlato.",
        ...
        "c'è più sostanza in una bolla di sapone.",
